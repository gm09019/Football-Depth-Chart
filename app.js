document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ensure GOOGLE_APPLICATION_CREDENTIALS is set in .env file
    ...
    async function loadSheetsData() {
      try {
        const response = await fetch(`https://sheets.googleapis.com/v4/spreadsheets/${SHEET_ID}/values:batchGet?ranges=Depth%20Chart!A2:Z1000&ranges=Play%20Data!A2:E1000&key=${process.env.GOOGLE_API_KEY}`);
